...
def add_categories():
    ...
    db = conn.getmyad_db
    category = ['Финансы', 'Электроника', 'Аксессуары', 'Игры', 'Одежда', 'Дети', 'Техника', 'Медицина', 'Спорт',
                'Посуда', 'Обучение', 'Зоотовары', 'Автомобили', 'Недвижимость', 'Стройка  и ремонт', 'Туризм',
                'Красота', 'Книги', 'Еда']
