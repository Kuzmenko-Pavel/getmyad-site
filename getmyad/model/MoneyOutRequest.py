...
class MoneyOutRequest(object):
    ...
    def send_confirmation_email(self):
        ...
        try:
            mail.confirmation_email.delay(email=email, payment_details=payment_details, confirm_link=confirm_link,
                                          date_expire=date_expire)
        except Exception as ex:
            mail.confirmation_email(email=email, payment_details=payment_details, confirm_link=confirm_link,
                                    date_expire=date_expire)
